...
export const stationsPool: StationsPool<Station> = {
    // STREAM STATIONS
    rtl: {              name: "RTL",                type: RADIO_TYPES.STREAM,   padding: 22,    interval: 3000, m3u8: "chunklist_b128000.m3u8", dynamicAac: true,   aac: "media-{}_b128000_",    link: "https://streamcdnb8-dd782ed59e2a4e86aabf6fc508674b59.msvdn.net/audiostream/S97044836/tbbP8T1ZRPBL/", thumbnail: "https://upload.wikimedia.org/wikipedia/it/thumb/2/25/RTL_102_5_logo.svg/1200px-RTL_102_5_logo.svg.png" },
    ...
    natsukashii: {      name: "Natsukashii",        type: RADIO_TYPES.SINGLE_LINK,  link: "https://igor.torontocast.com/SakuraNatsukashii",             thumbnail: "https://static.mytuner.mobi/media/tvos_radios/tjq25grgtzfg.jpeg" },
    j1gold: {           name: "J1Gold",             type: RADIO_TYPES.SINGLE_LINK,  link: "https://jenny.torontocast.com:2000/stream/j1gold/stream",    thumbnail: "https://cdn-profiles.tunein.com/s296850/images/logog.png?t=1" },
    shonanbeach: {      name: "ShonanBeach",        type: RADIO_TYPES.SINGLE_LINK,  link: "https://shonanbeachfm.out.airtime.pro/shonanbeachfm_a",      thumbnail: "https://static.mytuner.mobi/media/tvos_radios/Yve4FR2sFn.png" },
